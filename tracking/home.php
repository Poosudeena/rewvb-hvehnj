                            ...
                            <div class="col-lg-8 offset-2">
                                ...
                                <form action="" id="manage-records">
                                    ...
                                    <div id="details" <?php echo isset($id) ? "style='display:block'" : 'style="display:none"' ?>>
                                        ...
                                        <p><b>Required Component: <span id="name"><?php echo isset($id) ? ucwords($caddress) : '' ?></span></b></p>
                                        <p><b> Quantities Required: <span id="name"><?php echo isset($id) ? ucwords($caddress1) : '' ?></span></b></p>
                                        <p><b>Dept/Special lab: <span id="name"><?php echo isset($id) ? ucwords($caddress2) : '' ?></span></b></p>
                                        <p><b>Requested Special Lab: <span id="name"><?php echo isset($id) ? ucwords($caddress3) : '' ?></span></b></p>
                                        <input type="hidden" name="person_id" value="<?php echo isset($person_id) ? $person_id : '' ?>">

                                        <div class="form-group">
                                            <label for="" class="control-label">Approval Status</label>
