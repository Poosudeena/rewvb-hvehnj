...
$ids = implode(",",$ids);
$qry = $conn->query("SELECT *,concat(firstname) as name,concat(lastname) as name1, concat(hod_name) as name,concat(RequiredComponents) as caddress,concat(QuantitiesRequired) as caddress1,concat(Dept) as caddress2, concat(RequestedSpecialLab) as caddress3 FROM persons where id in ($ids) ");
