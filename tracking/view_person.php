...
$qry = $conn->query("SELECT *,concat(lastname,', ',firstname,' ',middlename) as name, concat(location,', ',special lab,', ',special lab incharge,', ',specail lab,', ',state,', ',specail lab code) as caddress FROM persons where id= ".$_GET['id']);
